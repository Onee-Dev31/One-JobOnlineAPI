#!/bin/bash
# Setup dotnet user-secrets for JobOnlineAPI (macOS/Linux)
...
dotnet user-secrets set "ConnectionStrings:DefaultConnection" \
  "Server=<DB_HOST>;Database=JobOnlineDB;User Id=<DB_USER>;Password=<DB_PASS>;Trusted_Connection=False;MultipleActiveResultSets=true;TrustServerCertificate=True;"
dotnet user-secrets set "ConnectionStrings:DefaultConnectionHRMS" \
  "Server=<DB_HOST>;Database=HRMS;User Id=<DB_USER>;Password=<DB_PASS>;Trusted_Connection=False;MultipleActiveResultSets=true;TrustServerCertificate=True;"
